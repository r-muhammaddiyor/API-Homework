...
const elExitButton = document.querySelector('#exitButton');
const elLoginButton = document.querySelector('#loginButton');
...
if(localStorage.getItem("token")) {
  elExitButton.classList.remove("hidden")
  elLoginButton.classList.add("hidden")
}
  ...
  if (evt.target.classList.contains('js-delete-button')) {
    ...
    `;
      ...
      if (check) {
        ...
        clone.querySelector('span').innerText = 'Please login.';
